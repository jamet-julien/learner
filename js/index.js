...
/***/ function(module, exports, __webpack_require__) {
	...
	var _learner = __webpack_require__(4);

	var oLearner = new _learner.Learner({
	    signals: [new _learner.Signal({ value: -0.2 }), new _learner.Signal({ weight: 0, value: 1 }), new _learner.Signal({ weight: 0.5, value: 0.8 })],
	    threshold: 0.3,
	    action: function action() {
	        console.log('premier learner');
	    }
	});

	var oLearner2 = new _learner.Learner({
	    signals: [new _learner.Signal({ value: -0.2 }), new _learner.Signal({ weight: 0, value: 1 }), new _learner.Signal({ weight: 0.5, value: 0.8 })],
	    threshold: 0.5,
	    action: function action() {
	        console.log('second learner');
	    }
	});
...
/***/ function(module, exports) {
	...
	var Learner = function () {
	  function Learner(_ref2) {
	    var _ref2$signals = _ref2.signals,
	        signals = _ref2$signals === undefined ? [] : _ref2$signals,
	        _ref2$threshold = _ref2.threshold,
	        threshold = _ref2$threshold === undefined ? 1 : _ref2$threshold,
	        _ref2$action = _ref2.action,
	        action = _ref2$action === undefined ? function () {
	      return true;
	    } : _ref2$action;
	  ...
	  _createClass(Learner, [{
	    key: "addSignal",
	    value: function addSignal(oSignals) {
